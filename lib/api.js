      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return (0, _superagent2.default)(method, route).set(header).catch(function (error) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 5;
            return _superagent2.default.get(route).set(header).catch(function (error) {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            ...
            return _context9.abrupt('return', _superagent2.default.post(route).set(header).field('type', 'file').field('parentId', parentId).attach('files', file.file, file.name).on('progress', function (event) {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            _context10.next = 5;
            return _superagent2.default.get(downloadUrl).set(header).responseType('blob').on('progress', function (event) {
              onProgress(event.percent);
            });
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            return _context11.abrupt('return', (0, _superagent2.default)(method, route).set(header).send(params));
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            ...
            return _context12.abrupt('return', (0, _superagent2.default)(method, route).type('application/json').set(header).send({ name: newName }));
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            ...
            return _context13.abrupt('return', (0, _superagent2.default)(method, route).set(header));
